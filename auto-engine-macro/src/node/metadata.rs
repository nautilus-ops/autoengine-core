...
pub(crate) fn expand_with_metadata(_attr: TokenStream, item: TokenStream) -> TokenStream {
    // 解析输入的 enum
...
pub(crate) fn expand_with_parameter(attr: TokenStream, item: TokenStream) -> TokenStream {
